...
import { SelectionModel } from '@angular/cdk/collections';
  ...
  export class CatalogFormSelectionComponent implements OnInit, OnDestroy {
    ...
    columnsToDisplay = ['checkBox', 'movieName', 'endRights', 'territory', 'rights', 'languages', 'dubbed', 'subtitle', 'delete'];
    ...
    ngOnInit() {
      ...
      this.subscription = this.selection.changed.subscribe(() => this.selectionChange.emit(this.selection.selected));
    }
