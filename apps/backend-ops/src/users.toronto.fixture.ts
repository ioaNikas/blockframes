/**
 * The list of users, ids, passwords to use in the Toronto demos.
 */
import { UserConfig } from './users.fixture';
...
export const USERS: UserConfig[] = [
  ...
  {
    uid: 'uJY5HNFXj8PUq8CcQvqni1Ywm0s1',
    email: 'cytest.thejokers@blockframes.com',
    password: 'blockframes'
  },
  {
    uid: 'mykt2DfYNFNvLeslFqY8R2GRnhm1',
    email: 'cytest.cjentertainment@blockframes.com',
    password: 'blockframes'
  },
  {
    uid: '1H0F5NJqfkMHRwLIqAnYbUECiO22',
    email: 'forfun@vincent.fr',
    password: 'blockframes'
  },
  {
